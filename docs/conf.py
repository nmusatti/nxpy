...
project = u'Nxpy'
copyright = u'2010 - 2018, Nicola Musatti'
...
exclude_patterns = ['_build', '_impl', '_test']
...
html_sidebars = { '**': 'sourceforge.html' }
...
latex_documents = [
  ('index', 'Nxpy.tex', u'Nxpy Documentation',
   u'Nicola Musatti', 'manual'),
]
...
man_pages = [
    ('index', 'nxpy', u'Nxpy Documentation',
     [u'Nicola Musatti'], 1)
]
